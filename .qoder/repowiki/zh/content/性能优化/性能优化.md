...
- [AppButton.kt:1-67](file://android/app/src/main/kotlin/com/photovault/app/ui/components/AppButton.kt#L1-L67)
...
- [LockViewModel.kt:18-42](file://android/app/src/main/kotlin/com/photovault/app/ui/lock/LockViewModel.kt#L18-L42)
- [VaultStore.kt:39-107](file://android/app/src/main/kotlin/com/photovault/app/ui/vault/VaultStore.kt#L39-L107)

## 架构总览
应用层通过 ViewModel 与数据层交互，数据层通过 Room 访问数据库，并通过 Hilt 注入加密组件。UI 使用 Compose 进行声明式渲染，异步操作集中在协程与 IO 线程池中执行。

```mermaid
graph TB
UI["UI 层<br/>AiHomeScreen.kt<br/>AppButton.kt"] --> VM["业务层<br/>LockViewModel.kt"]
...
- [AppLogger.kt:9-29](file://android/app/src/main/kotlin/com/photovault/app/AppLogger.kt#L9-L29)
- [VaultStore.kt:39-107](file://android/app/src/main/kotlin/com/photovault/app/ui/vault/VaultStore.kt#L39-L107)
...
**章节来源**
- [PhotoVaultApp.kt:12-30](file://android/app/src/main/kotlin/com/photovault/app/PhotoVaultApp.kt#L12-L30)
- [AppLogger.kt:16-42](file://android/app/src/main/kotlin/com/photovault/app/AppLogger.kt#L16-L42)
...
**章节来源**
- [VaultStore.kt:39-118](file://android/app/src/main/kotlin/com/photovault/app/ui/vault/VaultStore.kt#L39-L118)
...
**章节来源**
- [VaultStore.kt:47-154](file://android/app/src/main/kotlin/com/photovault/app/ui/vault/VaultStore.kt#L47-L154)
- [LockViewModel.kt:18-42](file://android/app/src/main/kotlin/com/photovault/app/ui/lock/LockViewModel.kt#L18-L42)
...
**章节来源**
- [PhotoVaultApp.kt:19-29](file://android/app/src/main/kotlin/com/photovault/app/PhotoVaultApp.kt#L19-L29)
- [AppLogger.kt:22-29](file://android/app/src/main/kotlin/com/photovault/app/AppLogger.kt#L22-L29)
- [VaultStore.kt:120-154](file://android/app/src/main/kotlin/com/photovault/app/ui/vault/VaultStore.kt#L120-L154)
- [LockViewModel.kt:168-184](file://android/app/src/main/kotlin/com/photovault/app/ui/lock/LockViewModel.kt#L168-L184)

## 结论
本指南从内存管理、异步处理、IO 优化、缓存设计、监控分析以及照片处理专项优化六个维度，给出了面向“AI照片保险库”的系统性优化策略。建议在实际落地时结合 Profiler 与日志埋点持续迭代，确保在大库与高并发场景下的稳定与高性能。
