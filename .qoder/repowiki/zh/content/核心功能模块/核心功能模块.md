...
- [SubscriptionStateEntity.kt](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/entity/SubscriptionStateEntity.kt)
...
- [SecuritySetting.kt](file://android/core/domain/src/main/kotlin/com/xpx/vault/domain/model/SecuritySetting.kt)
...
- [SubscriptionState.kt](file://android/core/domain/src/main/kotlin/com/xpx/vault/domain/model/SubscriptionState.kt)
</cite>

## 更新摘要
**所做更改**
- 更新所有包名引用从 `com.photovault` 到 `com.xpx.vault`
- 更新项目结构图中的包名路径
- 更新架构图中的包名映射
- 更新数据库ER图中的包名引用
- 更新所有代码示例和配置说明中的包名
...
**更新** 包重命名从 `com.photovault` 更新为 `com.xpx.vault`，影响所有核心模块的包路径引用。
...
**图表来源**
- [PhotoVaultDatabase.kt:14-35](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/PhotoVaultDatabase.kt#L14-L35)
- [AlbumDao.kt:10-17](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/dao/AlbumDao.kt#L10-L17)
- [SecuritySettingDao.kt:9-16](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/dao/SecuritySettingDao.kt#L9-L16)
...
- [SecuritySettingEntity.kt:7-18](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/entity/SecuritySettingEntity.kt#L7-L18)
...
- [SubscriptionStateEntity.kt:7-17](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/entity/SubscriptionStateEntity.kt#L7-L17)
...
- [SecuritySettingEntity.kt:7-18](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/entity/SecuritySettingEntity.kt#L7-L18)
- [SecuritySettingDao.kt:9-16](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/dao/SecuritySettingDao.kt#L9-L16)
- [SecuritySetting.kt:6-12](file://android/core/domain/src/main/kotlin/com/xpx/vault/domain/model/SecuritySetting.kt#L6-L12)
...
**章节来源**
- [AesCbcEngine.kt:25-32](file://android/core/data/src/main/kotlin/com/xpx/vault/data/crypto/AesCbcEngine.kt#L25-L32)
- [PasswordHasher.kt:17-24](file://android/core/data/src/main/kotlin/com/xpx/vault/data/crypto/PasswordHasher.kt#L17-L24)
- [AlbumDao.kt:12-13](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/dao/AlbumDao.kt#L12-L13)
- [PhotoAssetEntity.kt:29-32](file://android/core/data/src/main/kotlin/com/xpx/vault/data/db/entity/PhotoAssetEntity.kt#L29-L32)
...
**更新** 包重命名从 `com.photovault` 更新为 `com.xpx.vault`，所有模块的包路径现已统一更新。
