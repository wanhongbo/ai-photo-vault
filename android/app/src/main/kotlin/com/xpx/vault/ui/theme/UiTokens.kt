...
object UiColors {
    ...
    object Ai {
        ...
        val featureCardBg = Color(0xFF0C1523)
        val featureCardStroke = Color(0xFF223247)
        val featureTitle = Color(0xFFEAF1FF)
        val featureDesc = Color(0xFF8EA2C0)
...
object UiSize {
    ...
    val permissionCardTopPad: Dp = 48.dp
    val permissionCardBottomPad: Dp = 36.dp
    val permissionIconWrap: Dp = 92.dp
    val permissionIcon: Dp = 42.dp
    val permissionTitleTopGap: Dp = 20.dp
    val permissionBodyTopGap: Dp = 16.dp
    val permissionPrimaryTopGap: Dp = 28.dp
...
object UiTextSize {
    ...
    val homeSectionTitle: TextUnit = 18.sp
    ...
    val permissionTitle: TextUnit = 24.sp
    val permissionBody: TextUnit = 17.sp
    val permissionBodyLineHeight: TextUnit = 26.sp
