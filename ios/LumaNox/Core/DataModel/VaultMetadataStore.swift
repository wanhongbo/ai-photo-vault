...
final class VaultMetadataStore {
    ...
    func recordImportedMedia(
        ...
        snapshot.media.append(VaultMediaRecord(
            ...
            uti: details.uti,
            cipherVersion: VaultCipher.shared.cipherVersion(of: encryptedURL) ?? vaultCipherVersionAEADv2,
    ...
    private func buildRecord(
        ...
        return VaultMediaRecord(
            ...
            uti: previous?.uti,
            cipherVersion: VaultCipher.shared.cipherVersion(of: file) ?? previous?.cipherVersion ?? vaultCipherVersionCBCv1,
